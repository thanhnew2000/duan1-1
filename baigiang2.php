...
<!-- hết div.header2 -->
		...
		<div class="row" style="width:1350px">
			...
			<!-- 	  	<div style="width:360px;height:380px;background:green;float: left;overflow: auto;"> -->
				  ...
				  <div class="force-overflow">
						<?php foreach (comment_idcourse($idkh) as $value){ ?>
									...
									<p style="font-size: 13px;color: black;margin-top: -15px">
										...
										<?php if (isset($_SESSION['account'])){
											if ($_SESSION['account']['id']==$idnguoidung) {?>
												 <a href="baigiang2.php?idlesson=<?php echo $idlesson ?>&&idkh=<?php echo $idkh ?>&&xoaidbl=<?php echo $value['id_comment'] ?>" onclick="return confirm('Bạn có muốn xóa bình luận này?	')" style="float: right;margin-right: 5px">Xóa</a></p>
									<?php }
										} ?>
